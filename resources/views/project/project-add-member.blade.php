@extends('layout.app')
@section('title', 'Thêm thành viên cho dự án')
@section('css')
    <!-- Favicon icon -->
            ...
            <div class="col-sm-12">
                ...
                <div class="card container-fluid">
                    ...
                    <div class="card-block">
                        <form id="main" method="POST" action="{{ route('project.createmember') }}">
                            @csrf
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Dự án</label>
                                <div class="col-sm-10">
                                    <input type="hidden" class="form-control" name="ProjectId" id="name" value="{{$project->ProjectId}}">
                                    <input type="text" class="form-control" name="ProjectName" id="name" value="{{$project->ProjectName}}" disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="membersManager[] " class="form-control js-example-basic-multiple"
                                        multiple>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="membersContributor[] " class="form-control js-example-basic-multiple"
                                        multiple>
                                        @foreach ($members as $member)
                                            <option value="{{ $member->UserId }}">{{ $member->FullName }}</option>
                                        @endforeach
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Người quan sát</label>
                                <div class="col-sm-10">
                                    <select name="membersObserver[] " class="form-control js-example-basic-multiple"
                                        multiple>
                                        @foreach ($members as $member)
                                            <option value="{{ $member->UserId }}">{{ $member->FullName }}</option>
                                        @endforeach
