            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('project.add') }}"><button class="btn btn-grd-success">Thêm dự án
                                mới</button></a>
                    </div>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item"
                                                            href="{{ route('tasks.tasksWithProject', ['ProjectId' => $project->ProjectId]) }}"><i
                                                                class="icofont icofont-attachment"></i> Quản lý công
                                                            việc</a>
                                                        <a class="dropdown-item" href="#"><i
                                                                class="icofont icofont-ui-edit"></i> Chỉnh sửa</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item"
                                                            href="{{ route('project.list_member', ['ProjectId' => $project->ProjectId]) }}"><i
