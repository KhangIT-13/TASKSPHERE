        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>Các công việc của bạn</h4>
                        <span>Dưới đây là danh sách các công việc của bạn</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Tasks Board</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card card-border-default w-100">
                                <div class="card-header">
                                    <a href="{{ route('tasks.detail', ['TaskId' => $task->TaskId]) }}"
                                        class="card-title">#{{ $task->TaskId }}.
                                        {{ $task->TaskName }} </a>
                                    <span class="label label-success f-right">{{ $task->StartDate ? $task->StartDate->format('d-m-Y') :  \Carbon\Carbon::now()->format('d/m/Y') }} -
                                        {{$task->DueDate ? $task->DueDate->format('d-m-Y') :  \Carbon\Carbon::now()->format('d/m/Y') }}</span>
                                </div>
                                            ...
                                            <p class="task-due"><strong> Thời hạn : </strong>
                                                ...
                                                @else
                                                    <span class="countdown-timer"
                                                        data-due-date="{{$task->DueDate ? $task->DueDate->format('Y-m-d H:i:s') :  \Carbon\Carbon::now()->format('d/m/Y')}}">
                                                    </span>
                                                @endif
                                ...
                                <div class="card-footer d-flex align-center col-12">
                                    ...
                                    <div class="task-board col-4 m-0 p-0 d-flex justify-content-end">
                                        ...
                                        <label class="label {{ $statusClass }}">{{ ucfirst($task->Status) }}</label>
