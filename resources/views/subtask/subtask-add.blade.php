            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <form id="main" method="POST" action="{{ route('subtask.create') }}">
                            @csrf
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Tên nhiệm vụ</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="SubTaskName" id="name"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="datetime-local" class="form-control" id="email" name="DueDate">
                                    <span class="messages"></span>
                                </div>
                            </div>
                            <div class="form-group row">
...
@section('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const projectSelect = document.getElementById('task-select');
