            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="{{route('home')}}">
                            <img src="{{ asset('files/assets/images/logo.png') }}" width="50px" alt="logo.png"> <span><b>TASKSPHERE</b></span>
                        </a>
                                    ...
                                    <ul class="show-notification profile-notification dropdown-menu"
                                        ...
                                        <li>
                                            <a href="{{ route('profile.me') }}">
                                                <i class="feather icon-user"></i> Thông tin tài khoản
                                            </a>
                                        </li>
                                        {{-- <li>
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="{{ route('project.dash') }}">
                                                <span class="pcoded-mtext">Các dự án của tôi</span>
                                            </a>
                                        </li>
                                        <li class="">
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="{{ route('tasks.dash') }}">
                                                <span class="pcoded-mtext">Các công việc của tôi</span>
                                            </a>
                                        </li>
                                        <li class="">
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="{{ route('subtask.dash') }}">
                                                <span class="pcoded-mtext">Các nhiệm vụ của tôi</span>
                                            </a>
                                        </li>
                                        <li class="">
                                            <a href="{{ route('subtask.subtasklist') }}">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="pcoded-hasmenu ">
                                            ...
                                            <ul class="pcoded-submenu">
                                                ...
                                                <li class="">
                                                    <a
                                                        href="..\files\extra-pages\email-templates\email-newsletter.htm">
                                                ...
                                                <li class="">
                                                    <a
                                                        href="..\files\extra-pages\email-templates\email-activation.htm">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu ">
                                    <a href="javascript:void(0)">
                                        <span class="pcoded-micon"><i
                                                class="feather icon-search"></i><b>S</b></span>
