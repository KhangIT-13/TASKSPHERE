                ...
                <div class="col-sm-12">
                    ...
                    <form method="POST" action="{{ route('auth.login') }}" class="md-float-material form-material">
                        ...
                        <div class="text-center">
                            <img src="..\files\assets\images\logo.png" alt="logo.png" width="60px">
                        </div>
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="row m-b-20">
                                    ...
                                    <div class="col-md-6">
                                        <button class="btn btn-google m-b-20 btn-block"><i
                                                class="icofont icofont-google"></i>Google</button>
                                    </div>
                                </div>
                                <p class="text-muted text-center p-b-5">Đăng nhập bằng tài khoản của bạn</p>
                                
                                <!-- Hiển thị lỗi cho trường email nếu có -->
                                ...
                                <!-- Hiển thị lỗi cho trường password nếu có -->
                                <div class="form-group form-primary">
                                ...
                                <div class="row m-t-25 text-left">
                                    <div class="col-12">
                                        ...
                                        <div class="forgot-phone text-right f-right">
                                            <a href="{{route('auth.forgotpass')}}" class="text-right f-w-600"> Quên mật khẩu?</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <p class="text-inverse text-left">Bạn chưa có tài khoản?<a
                                        href="{{route('auth.register')}}"> <b class="f-w-600">Đăng ký tại đây </b></a>!</p>
                            </div>
                        </div>
                    </form>
